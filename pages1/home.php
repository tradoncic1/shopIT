<div id="myCarousel1" class="carousel slide" data-ride="carousel">
    ...
    <div id="carousel-css">
      <div class="carousel-inner">
          <div class="item active"> <img src="images/banner_nvidia.jpg" style="width:100%; height: 500px" alt="First slide">
              <div class="carousel-caption">
                  <h1>shopIT<br> tech</h1>
              </div>
          </div>
          <div class="item"> <img src="images/banner_lg.jpg" style="width:100%; height: 500px" alt="Second slide">
              <div class="carousel-caption">
                  <h1>shopIT<br> mobile</h1>
              </div>
          </div>
          <div class="item"> <img src="images/banner_red.jpg" style="width:100%; height: 500px" alt="Third slide">
              <div class="carousel-caption">
                  <h1>shopIT<br> photo</h1>
              </div>
          </div>
      </div>
    </div>
